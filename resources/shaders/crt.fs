...
//
// NOTE (HECTOR): To work with Raylib, I have changed a few of the values around and added, 
// a few new ones, but the underlying code has stayed the same. (Denoted by 'H:')
// from: Shadertoy, https://www.shadertoy.com/view/4scSR8

// H: Version not needed for Shadertoy, but is required for raylib
#version 330
